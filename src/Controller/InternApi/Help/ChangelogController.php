...
class ChangelogController extends AbstractController
{
    ...
    public function create(Request $request, ApiResponse $apiResponse, ValidatorService $validator,
                           DataHelp $dataEntity, HeChangelogRepository $repository): Response
    {
        return $this->submitForm("create", $repository, new HeChangelog(), $request, $apiResponse, $validator, $dataEntity);
    }
