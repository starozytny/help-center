...
export function Badge ({ type, children, onClick, classnames }) {
	const typeVariants = {
	...
	return <span className={cn("inline-flex items-center rounded-md px-2 py-1 text-xs font-medium", typeVariants[type], classnames)}
				 onClick={onClick}>
		{children}
	</span>
}
